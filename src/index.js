...
import { MapRender } from './utils/map-renderer';
...
const mapRender = new MapRender(canvasContext);
...
subscribe(() => {
    ...
    if (currentScreen.code !== getState().currentScreenCode){
        ...
        case 'GAME':
            ...
            currentScreen = new Game(mapRender, getState().map, getState().walls, getState().page, getState().character);
            break;
        }
    }
});
